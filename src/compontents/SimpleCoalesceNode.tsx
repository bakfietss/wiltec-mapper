...
const SimpleCoalesceNode: React.FC<{ data: SimpleCoalesceData; id: string }> = ({ data, id }) => {
      ...
      <div className="p-1">
        <div className="space-y-1">
          {rules.length > 0 ? (
            ...
            <div className="text-xs text-gray-500 italic p-2">No rules configured</div>
          )}
...
export default SimpleCoalesceNode;
