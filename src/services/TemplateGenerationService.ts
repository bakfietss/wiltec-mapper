export class TemplateGenerationService {
  ...
  private static getSmartMapping(outputKey: string, sourceObj: any): string | null {
    // Basic mappings for common field patterns
    const mappings: Record<string, string[]> = {
      'ID': ['id', '_id', 'ID', 'identifier'],
      'Reference': ['client_reference', 'reference', 'ref'],
      'Container_number': ['containers[0].container_number', 'container_number'],
      'Delivery_date': ['itinerary.actual_time_of_arrival', 'actual_time_of_arrival'],
